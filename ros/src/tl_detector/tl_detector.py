...
# number of waypoints before the next traffic light where traffic light is enabled
TL_DETECTION_DISTANCE = 2 * 120
...
class TLDetector(object):
    def __init__(self):
        ...
        # TODO Check the subscriber for is_site (/image_color or /image_raw)
    ...
    def process_traffic_lights(self):
        ...
        if closest_light:
            ...
            # print('closest light wp {} with color {}'.format(line_wp_idx, state))
            print('wp:{} light_wp:{} color:{} score:{:.3f}'.format(
                    car_wp_idx, line_wp_idx, state, score))
